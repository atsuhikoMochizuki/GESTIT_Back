...
insert into commune (nom, code_postal) values('Tulle',19000);
insert into commune (nom, code_postal) values('Clermont-ferrand',63000);
insert into commune (nom, code_postal) values('Nantes',44000);
insert into adresse (numero, voie, commune_id) values(12, 'rue du Faubourg Foch', 1);
insert into adresse (numero, voie, commune_id) values(1065, 'Avenue des lilas', 1);
insert into adresse (numero, voie, commune_id) values(35, 'Boulevard Champollion', 2);
...
insert into adresse (numero, voie, commune_id) values(15, 'Avenue de la mer', 3);
...
INSERT INTO commune (code_postal, nom) VALUES (84000, 'Avignon');
